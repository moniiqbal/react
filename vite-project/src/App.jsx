...
function App() {
  ...
  return (
    ...
    onCurrencyChange={(_currency) => setFrom(_currency)} // Use _currency as an unused variable
    selectCurrency={from}
...
/>
    ...
    currencyOptions={options}
    onCurrencyChange={(_currency) => setTo(_currency)} // Use _currency as an unused variable
    selectCurrency={to}
    amountDisable
/>
                        </div>
